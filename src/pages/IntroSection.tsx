...
const IntroSection = () => {
  return (
    <section
      id="home"
      className="min-h-screen flex items-center justify-center px-4 md:px-8 bg-background"
    >
      <div className="max-w-6xl mx-auto w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              I love building modern web apps that feel fast, intelligent, and
              intuitive—whether it's real-time experiences, automation, or
              AI-powered features. I focus on creating scalable solutions with
              clean architecture and engaging user interfaces that actually make
              an impact.
            </motion.p>
